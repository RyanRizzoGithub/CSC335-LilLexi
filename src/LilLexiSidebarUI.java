...
public class LilLexiSidebarUI {
	...
	public void start() {	
        ...
        Shell spellCheckShell = new Shell(display, SWT.NO_TRIM);
        ...
        Button closeSpellCheck = new Button(spellCheckShell, SWT.PUSH);
        closeSpellCheck.setText("Close");
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
	    ...
	    activateSpellCheck.addSelectionListener(new SelectionListener() {
	    	public void widgetSelected(SelectionEvent event) {
	    		...
	    		spellCheckShell.setVisible(true);
